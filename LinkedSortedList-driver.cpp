...
void copyConstructorTester(std::shared_ptr<SortedListInterface<std::string>> listPtr);

int main()
{
   
   std::shared_ptr<SortedListInterface<std::string>> listPtr = std::make_shared<LinkedSortedList<std::string>>();
